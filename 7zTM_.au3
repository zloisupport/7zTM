	...
	Func fn_patcher($theme, $type)
		...
		If $answer = 1 Then
			...
			Switch $type
				...
				Case 1
					ProgressOn("7-Zip Theme Manager", "", $lang[$ls][28])
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2002 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\48x36\Add.bmp"')
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2003 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\48x36\Extract.bmp"')
					ProgressSet(17)
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2004 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\48x36\Test.bmp"')
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2010 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\48x36\Copy.bmp"')
					ProgressSet(34)
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2011 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\48x36\Move.bmp"')
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2012 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\48x36\Delete.bmp"')
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2013 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\48x36\Info.bmp"')
					ProgressSet(51)
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2082 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\24x24\Add.bmp"')
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2083 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\24x24\Extract.bmp"')
					ProgressSet(68)
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2084 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\24x24\Test.bmp"')
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2090 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\24x24\Copy.bmp"')
					ProgressSet(85)
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2091 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\24x24\Move.bmp"')
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2092 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\24x24\Delete.bmp"')
					RunWait(@ScriptDir & '\Resourcer.exe -op:upd -src:"' & $var_file_7zfm & '" -type:bitmap -name:2093 -lang:1033 -file:"' & @ScriptDir & "\toolbar\" & $theme & '\24x24\Info.bmp"')
					ProgressSet(100, $lang[$ls][29], "")
					Sleep(1000)
					ProgressOff()
				Case 9
